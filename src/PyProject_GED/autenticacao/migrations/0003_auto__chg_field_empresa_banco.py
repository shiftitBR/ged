...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Empresa.banco'
        db.alter_column('tb_empresa', 'banco', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Empresa.banco'
        db.alter_column('tb_empresa', 'banco', self.gf('django.db.models.fields.CharField')(max_length=20))
