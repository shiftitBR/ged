...
from PyProject_GED.relatorios.utils import get_attr_value, calculate_size, memoize
...
from PyProject_GED.relatorios.base import GeraldoObject, ManyElements
from PyProject_GED.relatorios.cache import CACHE_BY_QUERYSET, CACHE_BY_RENDER, CACHE_DISABLED,\
