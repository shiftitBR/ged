...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Documento.eh_pulbico'
        db.delete_column('tb_documento', 'eh_pulbico')

        # Adding field 'Documento.eh_publico'
        db.add_column('tb_documento', 'eh_publico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Documento.data_validade'
        db.alter_column('tb_documento', 'data_validade', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Documento.data_descarte'
        db.alter_column('tb_documento', 'data_descarte', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Versao.protocolo'
        db.alter_column('tb_versao', 'protocolo', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Versao.dsc_modificacao'
        db.alter_column('tb_versao', 'dsc_modificacao', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Adding field 'Documento.eh_pulbico'
        db.add_column('tb_documento', 'eh_pulbico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Documento.eh_publico'
        db.delete_column('tb_documento', 'eh_publico')


        # Changing field 'Documento.data_validade'
        db.alter_column('tb_documento', 'data_validade', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Documento.data_descarte'
        db.alter_column('tb_documento', 'data_descarte', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Versao.protocolo'
        db.alter_column('tb_versao', 'protocolo', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))

        # Changing field 'Versao.dsc_modificacao'
        db.alter_column('tb_versao', 'dsc_modificacao', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
