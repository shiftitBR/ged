...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tb_documento', (
            ...
            ('data_validade', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('data_descarte', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('eh_publico', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('empresa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['autenticacao.Empresa'])),
        ))
        ...
        db.create_table('tb_versao', (
            ...
            ('dsc_modificacao', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('upload', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multiuploader.MultiuploaderImage'])),
            ('protocolo', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
