...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Versao.arquivo'
        db.delete_column('tb_versao', 'arquivo')

        # Adding field 'Versao.upload'
        db.add_column('tb_versao', 'upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['multiuploader.MultiuploaderImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Versao.arquivo'
        db.add_column('tb_versao', 'arquivo',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200),
                      keep_default=False)

        # Deleting field 'Versao.upload'
        db.delete_column('tb_versao', 'upload_id')
